...
from lounger.commons.project_run_config import get_project_config, get_project_name
...
def get_case_path() -> List[str]:
    ...
    try:
        ...
        return _get_specific_test_cases(need_test_projects, project_name_list)
...
def _get_custom_cases(case_specification: str) -> List[str]:
    ...
    """
    case_paths = []
    case_name = config_utils.get_config("Test_Project", case_specification)
